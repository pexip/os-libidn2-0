...
const char *gengetopt_args_info_help[] = {
  ...
  "  -N, --tr46nt    Eable TR46 non-transitional processing  (default=off)",
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->tr46t_help = gengetopt_args_info_help[4] ;
  args_info->tr46nt_help = gengetopt_args_info_help[5] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVlrTN", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'T':	/* Enable TR46 transitional processing.  */
          ...
          break;
        case 'N':	/* Eable TR46 non-transitional processing.  */
